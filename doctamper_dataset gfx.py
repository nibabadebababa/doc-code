...
class DocTamperDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # 处理掩码 - 直接从 mask_image 提取掩码（可去掉，因为是给SAM处理的）
        ...
        ##去掉SAM的ResizeLongestSide和transform后可以去掉这个
        # 计算缩放比例
        ...
        return (
            ...
            #masks,
            label,
            resize,##替换为image的height和width以便于val返回来计算iou，f1和precision
            questions,
            #centers_tensor,
...
if __name__ == "__main__":
    ...
    if len(hybrid_dataset.all_datasets) > 0:
        ...
        for i, step in enumerate(test_steps):
            ...
            _, image_tensor, _, _, _, _, _, _, _ = sample
